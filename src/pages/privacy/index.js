    ...
    <Layout>
      ...
      <ArticleWrapper>
        <Article>
          ...
          <ol>
            <li>Ilość punktów, którą obliczyłeś za pomocą naszego kalkulatora punktów (tylko wtedy, gdy wyrazisz na to
              zgodę)
            </li>
          ...
          <p>
            <i>Jeśli chcesz poczytać więcej na temat WebStorage i IndexedDB polecam strony:<br/>
              <TextLink wrapper="a"
                        href="https://developer.mozilla.org/en-US/docs/Web/API/Web_Storage_API">https://developer.mozilla.org/en-US/docs/Web/API/Web_Storage_API</TextLink>
              <br/>
              <TextLink wrapper="a"
                        href="https://developer.mozilla.org/en-US/docs/Web/API/IndexedDB_API">https://developer.mozilla.org/en-US/docs/Web/API/IndexedDB_API</TextLink>
            </i>
          </p>
          <h3>Jak mogę usunąć te dane?</h3>
          <p>
            Wejdź na <TextLink to="/privacy/settings">naszą stronę ustawień prywatności</TextLink> i kliknij "Wyczyść
            wszystkie dane"
          </p>
