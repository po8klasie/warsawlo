      ...
      <ArticleWrapper>
        <Article>
          ...
          <p>
            ...
            z serwisu "Otwarte dane po warszawsku" <TextLink wrapper="a"
                                                             href="http://api.um.warszawa.pl">(api.um.warszawa.pl)</TextLink> w
            dniu 8.02.2019 r.
          ...
          <p>
            ...
            zaczerpneliśmy z dokumentów pdf z Serwisu Biura Edukacji m.st. Warszawy <TextLink wrapper="a"
                                                                                              href="http://edukacja.warszawa.pl">(edukacja.warszawa.pl)</TextLink>,
            które przetworzyliśmy do przyjaznego formatu.
          </p>
          <h3>HERE Maps API</h3>
          <p>
            Lokalizacja szkół udostępniona przez Miasto Stołeczne Warszawa zawiera tylko dane adresowe
            Z pomocą Here Maps API <TextLink wrapper="a"
                                             href="http://developer.here.com">(developer.here.com)</TextLink> poddaliśmy
            je procesowi geolokalizacji, czyli mówiąc prościej,
            pobraliśmy współrzędne geograficzne odpowiadające adresom, dzięki czemu możemy prezentować mapy oraz
            wskazówki dojazdu.
          </p>
          <h3>Społeczność</h3>
          <p>
            Przecież to serwis tworzony przez uczniów dla uczniów, więc największym źródłem informacji jesteśmy my!
            Wszelkie błędy zostają poprawione "manualnie" po werfikacji, w związku z tym dane w naszym serwisie mogą się
            różnić od danych pobranych za pomocą API.
          </p>
